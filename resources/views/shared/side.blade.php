  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" data-bs-target="#store-nav" data-bs-toggle="collapse" href="#">
        <i class="bi bi-house"></i><span>Store</span><i class="bi bi-chevron-down ms-auto"></i>
      </a>
      <ul id="store-nav"
        class="nav-content collapse {{ request()->routeIs('stores.create') ? 'show' : '' }}"
        data-bs-parent="#sidebar-nav">

        <li>
          <a href="{{ route('stores.create') }}" class="{{ request()->routeIs('stores.create') ? 'active' : '' }}">
            <i class="bi bi-circle"></i><span>Create</span>
          </a>
        </li>

        <li>
          <a href="{{ route('stores.index') }}" class="{{ request()->routeIs('stores.index') ? 'active' : '' }}">
    ...
    <li class="nav-item">
      ...
      <ul id="items-nav"
        class="nav-content collapse {{  request()->routeIs('items.create') ? 'show' : '' }}"
        data-bs-parent="#sidebar-nav">
